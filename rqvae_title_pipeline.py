#!/usr/bin/env python3
"""
LD_LIBRARY_PATH=/usr/lib/x86_64-linux-gnu:$LD_LIBRARY_PATH python3 /root/judge/rqvae_title_pipeline.py \
    --input_json /root/judge/judge_results_SG_20260609.json \
    --output_dir /root/judge/rqvae_outputs_rubric \
...
LOGGER = logging.getLogger("rqvae_title")
...
def main() -> None:
    ...
    parser.add_argument("--input_json", default="/root/judge/judge_results_SG_20260609.json")
    parser.add_argument("--output_dir", default="/root/judge/rqvae_outputs")
    ...
    for exp_idx, hp in enumerate(grid, start=1):
        for seed in args.seeds:
            ...
            for i, sid in enumerate(ids):
                ...
                row = {"rubric_id": int(base["rubric_id"]), "source_query": base["source_query"], "dimension": base["dimension"], "title": base["title"], "description": base["description"], "criteria": base["criteria"]}
